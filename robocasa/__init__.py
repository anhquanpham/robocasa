...
# === single_stage and multi_stage envs (from robocasa_omni, for GR00T + guidance) ===
from robocasa.environments.kitchen.multi_stage.baking.cupcake_cleanup import (
    CupcakeCleanup as CupcakeCleanupMultiStage,
)
from robocasa.environments.kitchen.multi_stage.baking.organize_baking_ingredients import (
    OrganizeBakingIngredients as OrganizeBakingIngredientsMultiStage,
)
from robocasa.environments.kitchen.multi_stage.baking.pastry_display import (
    PastryDisplay as PastryDisplayMultiStage,
)
from robocasa.environments.kitchen.multi_stage.boiling.fill_kettle import FillKettle as FillKettleMultiStage
from robocasa.environments.kitchen.multi_stage.boiling.heat_multiple_water import (
    HeatMultipleWater as HeatMultipleWaterMultiStage,
)
...
from robocasa.environments.kitchen.multi_stage.brewing.prepare_coffee import (
    PrepareCoffee as PrepareCoffeeMultiStage,
)
...
from robocasa.environments.kitchen.multi_stage.chopping_food.organize_vegetables import (
    OrganizeVegetables as OrganizeVegetablesMultiStage,
)
...
from robocasa.environments.kitchen.multi_stage.making_toast.cheesy_bread import (
    CheesyBread as CheesyBreadMultiStage,
)
...
from robocasa.environments.kitchen.multi_stage.washing_dishes.sorting_cleanup import (
    SortingCleanup as SortingCleanupMultiStage,
)
...
from robocasa.environments.kitchen.single_stage.kitchen_doors import (
    CloseDoor as CloseDoorSingleStage,
    CloseDoubleDoor,
    CloseSingleDoor,
    OpenDoor as OpenDoorSingleStage,
    OpenDoubleDoor,
    OpenSingleDoor,
)
from robocasa.environments.kitchen.single_stage.kitchen_drawer import (
    CloseDrawer as CloseDrawerSingleStage,
    OpenDrawer as OpenDrawerSingleStage,
)
from robocasa.environments.kitchen.single_stage.kitchen_microwave import (
    TurnOffMicrowave as TurnOffMicrowaveSingleStage,
    TurnOnMicrowave as TurnOnMicrowaveSingleStage,
)
from robocasa.environments.kitchen.single_stage.kitchen_navigate import NavigateKitchen as NavigateKitchenSingleStage
...
from robocasa.environments.kitchen.single_stage.kitchen_sink import (
    TurnOffSinkFaucet as TurnOffSinkFaucetSingleStage,
    TurnOnSinkFaucet as TurnOnSinkFaucetSingleStage,
)
from robocasa.environments.kitchen.single_stage.kitchen_stove import (
    TurnOffStove as TurnOffStoveSingleStage,
    TurnOnStove as TurnOnStoveSingleStage,
)

# GR00T + guidance support
